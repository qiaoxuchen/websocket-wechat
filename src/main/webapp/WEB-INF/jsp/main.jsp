	...
	websocket.onmessage = function(event) { 
		...
		if(data.from==undefined||data.from==null||data.from==""){
			...
			$(data.userList).each(function(){
			    if(this.nickname==sessionName){
				$("#chatUserList").append("<li style='color:red;text-align:center'>"+this.nickname+"</li>");
                }else{
                $("#chatUserList").append("<li style='text-align:center'>"+this.nickname+"</li>");
                }
